package com.github.angelndevil2.dseew.jetty;

import com.github.angelndevil2.dseew.servlet.*;
...
public class JettyServer implements Runnable, Serializable {
    ...
    public void run() {
        ...
        servletContext.setResourceBase(PropertiesUtil.getWebBaseDir());

        // TODO copy for later use

/*        servletContext.addServlet(indexServlet.class.getCanonicalName(), "/mbean-explorer");
        servletContext.addServlet(indexServlet.class.getCanonicalName(), "/server-manage");*/
/*        servletContext.addServlet(new ServletHolder(new HelloServlet()),"*//*");
        ...
        jerseyServlet.setInitParameter(
                ...
                (new StringBuilder()).append((EntryPoint.class.getCanonicalName()))
                        .append(",")
                        .append(AccessControlAllowFilter.class.getCanonicalName())
                        .append(",")
